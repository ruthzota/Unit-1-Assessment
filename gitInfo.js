...
let gitDefinition = "A version control system that allows individuals and teams to track changes to code projects.";
...
//CODE HERE
let gitHubDefinition = "A web-based interface that uses Git, the open source version control software that lets multiple people make separate changes to web pages at the same time.";
